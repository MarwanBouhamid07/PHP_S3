first i was declare a variables hav a information of databse (database name  , host and password also  username )
...
in classification try()  i try to make a connection with my databse :
